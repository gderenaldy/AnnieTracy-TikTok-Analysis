...
with tiktok_container:
	...
	with tab1: 
		...
		tk_data = pd.read_csv("~/Desktop/CraftIQ/Projects/GitHub/AnnieTracy-TikTok-Analysis/Data/Follower activity.csv")
	...
	with tab2:
		...
		tk_social_data = pd.read_csv("~/Desktop/CraftIQ/Projects/GitHub/AnnieTracy-TikTok-Analysis/Data/Annie Tracy_TikTok_Social_Analytics.csv")
	...
	with tab3:
		...
		tk_data = pd.read_csv('~/Desktop/CraftIQ/Projects/GitHub/AnnieTracy-TikTok-Analysis/Data/z_RegressionSocialData.csv')
